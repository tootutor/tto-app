...
ttoApp.run(function ($rootScope, $location, $mdSidenav, Restangular, $mdDialog) {
  ...
  , position: 'absolute'  // Element positioning
	...
	if ($rootScope.token > '') {
	  ...
	  Restangular.one('user/profile', userId).get({}, $rootScope.headerObj)
	  .then(function (data) {
